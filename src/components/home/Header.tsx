    ...
    <nav className="w-full border-b px-6 sm:px-10 md:px-20 py-4 flex justify-between items-center absolute top-0 left-0 z-10 bg-transparent">
      ...
      <div className="flex items-center gap-3">
        ...
        <Link href="/" className="flex items-center gap-3">
          <div className="w-7 h-7 bg-purple-200 rounded-full"></div> {/* Slightly smaller */} 
          <span className="font-semibold text-xl text-gray-800">TaskZen</span> 
        </Link>
      </div>
      <div className="hidden md:flex items-center gap-4">
        <Link href="/demo" className="text-sm font-medium text-gray-500 hover:text-gray-900 transition-colors px-3 py-2">
          Book a Demo
        </Link>
        <ShimmerButton
           borderRadius="8px"
           ...
           shimmerColor="#e5e7eb"
           className="border py-1.5 border-black hover:border-gray-200 transition-colors duration-300"
         >
           <Link href="/login" className="block text-sm font-medium text-gray-500 hover:text-gray-900 transition-colors px-3 py-1">
             Log in
           </Link>
        </ShimmerButton>
        <ShimmerButton
        ...
        >
          <Link href="/signup" className="block  text-sm font-semibold text-white px-4 py-1 ">
            Sign Up
          </Link>
        </ShimmerButton>
      </div>
